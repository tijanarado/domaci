...
describe("Register test", ()=>{
    ...
    // cy.get(locators.registre.passwordInput).type(faker.internet.password(9, true))
    // cy.get(locators.registre.confirmPassword).type(faker.internet.confirmPassword(9, true))
